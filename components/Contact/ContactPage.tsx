  ...
  return (
    <>
      <section className="min-h-screen flex flex-col justify-center items-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-extrabold text-text text-center z-10">Let&apos;s build something remarkable</h1>
      ...
      <section className="pt-8 md:pt-12 max-w-4xl mx-auto">
        <SectionText>
          ...
          <SectionText.Paragraph>
            ...
            <div className=" grid grid-cols-2 md:flex md:flex-row items-center justify-center gap-8 md:gap-16 mt-10 mb-20">
              <div>
