...
const socialItems = [
  ...
  return (
    // <header ref={navRef} className="bg-pf-surface shadow-lg rounded-md sticky top-8 z-50 border border-surface border-solid">
    //   <nav>
    ...
    //       <div className="flex justify-between items-center md:gap-x-8">
